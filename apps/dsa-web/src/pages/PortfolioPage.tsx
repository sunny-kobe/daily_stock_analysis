...
import { StrategyValidationReview } from '../components/portfolio/StrategyValidationReview';
                  ...
                  {positionRows.map((row) => {
                    ...
                    <tr key={rowKey} className="border-b border-white/5">
                      ...
                      <td className="w-48 min-w-48 max-w-48 py-2 pr-2 align-top">
                        {stockName ? (
                          <div className="truncate text-sm text-foreground" title={stockName}>{stockName}</div>
                        ) : null}
