...
本个人 fork 同时维护一条基于真实持仓的投资学习主线：DSA 账本提供持仓事实，学习档案记录个人目标与认知边界，当前上下文保存带时间戳的组合快照，学习记录沉淀经核验后真正改变判断的方法。入口见 [个人投资学习档案](docs/personal-investment/个人投资学习档案.md)。这些文档包含公开的个人持仓、成本与现金信息，不构成投资建议。
