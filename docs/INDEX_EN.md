...
| [DSA Portfolio Research Control Plane](portfolio-research-workflow.md) (Chinese-only) | Single portfolio truth, instrument/risk control plane, four minimal research paths, fail-closed routing, and 20-day prospective validation |
| [Strategy Backtesting And Validation](strategy-validation.md) (Chinese-only) | Versioned strategies, leakage-resistant historical tests, simulation, small-capital validation, scorecards, and human stage changes |
