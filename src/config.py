...
class Config:
    ...
    # 是否允许全市场快照源参与单票实时 fallback。关闭时 efinance/akshare_em
    # 只由批量预取流程使用，避免单票请求被全市场接口拖慢。
    realtime_full_market_fallback_enabled: bool = False
    # 实时行情缓存时间（秒）
    ...
    def _load_from_env(cls) -> 'Config':
        ...
        return cls(
            ...
            realtime_full_market_fallback_enabled=os.getenv(
